...
const items := {
	...
	"iron_axe_crack1": {
		"texture": preload("res://res/sprites/items/weapons/iron_axe_crack1.png"),
		"durability": 100,
		"attack_speed": 1.1,
		"damage": 3.2,
		"damage_types": {
	...
	"iron_pickaxe_crack2": {
		"texture": preload("res://res/sprites/items/weapons/iron_pickaxe_crack2.png"),
		"durability": 100,
		"attack_speed": 1.1,
		"damage": 3.2,
		"damage_types": {
